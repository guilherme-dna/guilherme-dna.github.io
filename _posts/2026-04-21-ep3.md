...
Following the tutorial on [Linux kernel build configuration and modules](URL), the main goal was to understand how the kernel is organized in terms of features and how we can extend it by creating our own modules.
